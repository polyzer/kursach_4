function [rmse,Tform]=ICP_TForm(ImRgb1,pointCloud1,ImRgb2,pointCloud2)
    ...
    if useShowFigures
        pointCloudAligned = pctransform(pointCloud2, Tform);
        figure; pcshow(pointCloudAligned); title('res');
    end
end
